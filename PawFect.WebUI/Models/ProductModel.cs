...
namespace PawFect.WebUI.Models
{
    public class ProductModel
    {
        ...
        [Required]
        [StringLength(100, MinimumLength = 3, ErrorMessage = "Ürün adı min 3 max 30 karakter olmalıdır.")]
        ...
        [StringLength(500, MinimumLength = 5, ErrorMessage = "Ürün açıklaması min 5 max 200 karakter olmalıdır.")]
